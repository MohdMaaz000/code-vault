...
- Problem Link: [https://leetcode.com/problems/swap-nodes-in-pairs/](https://leetcode.com/problems/swap-nodes-in-pairs/)
...
| Language | Python3 |
| Runtime | 0 ms (100.00%) |
| Memory | 19.3 MB (22.99%) |
| Submission ID | 2145989141 |
